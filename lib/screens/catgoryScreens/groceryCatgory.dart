...
class GroceryCatgory extends StatefulWidget {
  const GroceryCatgory({super.key});
  @override
  State<GroceryCatgory> createState() => _GroceryCatgoryState();
}
class _GroceryCatgoryState extends State<GroceryCatgory> {
  bool isLoading = true;
  CatgoryModel? catgoryList;
  getMobileProducts() async {
    catgoryList = await CatgoryApi().getGrocerys();
    setState(() {
      isLoading = false;
    });
  }
