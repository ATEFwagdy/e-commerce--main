...
class ManCatgory extends StatefulWidget {
  const ManCatgory({super.key});
  @override
  State<ManCatgory> createState() => _ManCatgoryState();
}
class _ManCatgoryState extends State<ManCatgory> {
  bool isLoading = true;
  CatgoryModel? catgoryList;
  getMobileProducts() async {
    catgoryList = await CatgoryApi().getMans();
    setState(() {
      isLoading = false;
    });
  }
