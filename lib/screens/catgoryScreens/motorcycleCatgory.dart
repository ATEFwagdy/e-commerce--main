...
class MotorcyclCatgory extends StatefulWidget {
  const MotorcyclCatgory({super.key});
  @override
  State<MotorcyclCatgory> createState() => _MotorcyclCatgoryState();
}
class _MotorcyclCatgoryState extends State<MotorcyclCatgory> {
  bool isLoading = true;
  CatgoryModel? catgoryList;
  getMobileProducts() async {
    catgoryList = await CatgoryApi().getMotocycle();
    setState(() {
      isLoading = false;
    });
  }
