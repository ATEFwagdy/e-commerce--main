...
import 'package:e_commerce/servises/Api/catgorysApi.dart';
...
class LapCatgory extends StatefulWidget {
  const LapCatgory({super.key});
  @override
  State<LapCatgory> createState() => _LapCatgoryState();
}

class _LapCatgoryState extends State<LapCatgory> {
  bool isLoading = true;
  CatgoryModel? catgoryList;
  getLaptopProducts() async {
    catgoryList = await CatgoryApi().getLaptops();
    setState(() {
      isLoading = false;
    });
  }
