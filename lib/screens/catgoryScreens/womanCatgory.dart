...
class WomanCatgory extends StatefulWidget {
  const WomanCatgory({super.key});
  @override
  State<WomanCatgory> createState() => _WomanCatgoryState();
}
class _WomanCatgoryState extends State<WomanCatgory> {
  bool isLoading = true;
  CatgoryModel? catgoryList;
  getMobileProducts() async {
    catgoryList = await CatgoryApi().getWomans();
    setState(() {
      isLoading = false;
    });
  }
