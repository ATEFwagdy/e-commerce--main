...
class MobileCatgory extends StatefulWidget {
  const MobileCatgory({super.key});
  @override
  State<MobileCatgory> createState() => _MobileCatgoryState();
}
class _MobileCatgoryState extends State<MobileCatgory> {
  bool isLoading = true;
  CatgoryModel? catgoryList;
  getMobileProducts() async {
    catgoryList = await CatgoryApi().getMobiles();
    setState(() {
      isLoading = false;
    });
  }
