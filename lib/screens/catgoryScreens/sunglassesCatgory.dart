...
class SunglassesCatgory extends StatefulWidget {
  const SunglassesCatgory({super.key});
  @override
  State<SunglassesCatgory> createState() => _SunglassesCatgoryState();
}
class _SunglassesCatgoryState extends State<SunglassesCatgory> {
  bool isLoading = true;
  CatgoryModel? catgoryList;
  getMobileProducts() async {
    catgoryList = await CatgoryApi().getSunGlasses();
    setState(() {
      isLoading = false;
    });
  }
