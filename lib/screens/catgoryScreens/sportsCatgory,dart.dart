...
class SportsCatgory extends StatefulWidget {
  const SportsCatgory({super.key});
  @override
  State<SportsCatgory> createState() => _SportsCatgoryState();
}
class _SportsCatgoryState extends State<SportsCatgory> {
  bool isLoading = true;
  CatgoryModel? catgoryList;
  getMobileProducts() async {
    catgoryList = await CatgoryApi().getSportsTools();
    setState(() {
      isLoading = false;
    });
  }
